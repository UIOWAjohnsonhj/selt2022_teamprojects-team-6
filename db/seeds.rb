...
faculties = [{:first_name => 'Kiana-faculty', :last_name => 'Erickson', :user_name => 'kberickson_f', :password_digest=>"1234",:email =>"test@gmail.com"},
            {:first_name => 'Joslin-faculty', :last_name => 'Some', :user_name => 'jsome_f', :password_digest=>"1234"},
            {:first_name => 'Evan-faculty', :last_name => 'Brewer', :user_name => 'ebrewer_f', :password_digest=>"1234"},
            {:first_name => 'Ben-faculty', :last_name => 'Desollar', :user_name => 'bdesollar_f', :password_digest=>"1234"},
            {:first_name => 'Adnane-faculty', :last_name => 'Ezouhri', :user_name => 'aezouhri_f', :password_digest=>"1234"},
            {:first_name => 'Christian-faculty', :last_name => 'Baseme', :user_name => 'cbaseme_f', :password_digest=>"1234"},
]
